...
public class Main {
    public static void main(String[] args) {
        ...
        List<Transaction> tr2011 = transactions.stream()
                ...
                .sorted(comparing(Transaction::getValor).thenComparing(transaction -> transaction.getTrader().getNombre()))
                .collect(toList());
        ...
        boolean milanBased = transactions.stream()
                ...
                /****Si el campo ciudad es nullable, se puede usar operador ternario para evitar una NullPointerException.****/
